...
var _addasd = yhover - 30 + ysin - sprite_get_height(sCarta)/8;

// vetor local do texto em relação ao centro da carta (antes da rotação)
var _dist = point_distance(0, 0, 0, _addasd);
var _dir  = point_direction(0, 0, 0, _addasd) + angle;

// posição final já rotacionada em torno do centro (x, y)
var _tx = x + lengthdir_x(_dist, _dir);
var _ty = y + lengthdir_y(_dist, _dir);

// pequeno offset da sombra (3px), também rotacionado igual
var _shadow_dist = point_distance(0, 0, 0, 3);
var _shadow_dir  = point_direction(0, 0, 0, 3) + angle;
var _stx = _tx + lengthdir_x(_shadow_dist, _shadow_dir);
